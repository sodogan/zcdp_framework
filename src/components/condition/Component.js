sap.ui.define([
    ...
    function(UIComponent, ListSelector) {
        ...
        var Component = UIComponent.extend("aklc.cm.components.condition.Component", {

            metadata: {
                rootView: "aklc.cm.components.condition.view.Main",
                dependencies: {
                    version: "1.8",
                    libs: ["sap.ui.core"]
                },
                ...
                properties: {
                    ...
                    eventBusSubscription: {
                        ...
                        type: "object",
                        defaultValue: {
                            channel: "condition", //need to overwrite
                            events: {
        ...
        Component.prototype.getRootPath = function() {
            if (!this.rootPath) {
                this.rootPath = jQuery.sap.getModulePath("aklc.cm.components.condition");
            }
