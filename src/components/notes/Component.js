sap.ui.define([
    ...
    function(UIComponent) {
        ...
        var Component = UIComponent.extend("aklc.cm.components.notes.Component", {

            metadata: {
                rootView: "aklc.cm.components.notes.view.Main",
                dependencies: {
                    version: "1.8",
                    libs: ["sap.ui.core"]
                },
               config: {
                ...
                properties: {
                    ...
                    eventBusSubscription: {
                        ...
                        type: "object",
                        defaultValue: {
                            channel: "notes", //need to overwrite
                            events: {
        ...
        Component.prototype.getRootPath = function() {
            if (!this.rootPath) {
                this.rootPath = jQuery.sap.getModulePath("aklc.cm.components.notes");
            }
