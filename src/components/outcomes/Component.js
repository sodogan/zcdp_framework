sap.ui.define([
    ...
    function(UIComponent, ListSelector) {
        ...
        var Component = UIComponent.extend("aklc.cm.components.outcomes.Component", {

            metadata: {
                rootView: "aklc.cm.components.outcomes.view.Main",
                dependencies: {
                    version: "1.8",
                    libs: ["sap.ui.core"]
                },
        ...
        Component.prototype.getRootPath = function() {
            if (!this.rootPath) {
                this.rootPath = jQuery.sap.getModulePath("aklc.cm.components.outcomes");
            }
